...
def callrail_call_modified_webhook():
    ...
    # ВРЕМЕННО: логируем полную структуру, чтобы увидеть точный формат JSON
    print("=== CALL MODIFIED RAW PAYLOAD ===")
    print(data)
    print("=== END CALL MODIFIED RAW PAYLOAD ===")
    ...
    # проверяем несколько вариантов и ищем нужные теги без учёта регистра
